                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <div class="footer-widget footer-about mb-40">
                            <div class="footer-logo">
                                <a href="index.html"><img src="{{asset('client/assets/images/logo/logo.png')}}" alt="logo"></a>
                            </div>
                            <p>Lorem ipsum dolor sit amet, cons adipi elit, sed do eiusmod tempor incididunt ut aliqua.</p>
                            <div class="payment-img">
                                <a href="#"><img src="{{asset('client/assets/images/icon-img/payment.png')}}" alt="logo"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                ...
                <div class="row gx-0">
                    <div class="col-lg-5 col-md-5 col-12">
                        <div class="modal-img-wrap">
                            <img src="{{asset('client/assets/images/product/quickview.png')}}" alt="">
                        </div>
                    </div>
