...
@section('content')
            ...
            <div class="row align-items-center flex-row-reverse">
                ...
                <div class="col-lg-6">
                    <div class="about-img" data-aos="fade-up" data-aos-delay="400">
                        <img src="{{asset('client/assets/images/banner/about-us.png')}}" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="banner-area pb-100">
        <div class="bg-img bg-padding-2" style="background-image:url({{asset('client/assets/images/bg/bg-2.png')}})">
            <div class="container">
    ...
    <div class="funfact-area bg-img pt-100 pb-70" style="background-image:url({{asset('client/assets/images/bg/bg-4.png')}})">
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-6 col-6">
                    <div class="single-funfact text-center mb-30" data-aos="fade-up" data-aos-delay="200">
                        <div class="funfact-img">
                            <img src="{{asset('client/assets/images/icon-img/client.png')}}" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-6">
                    <div class="single-funfact text-center mb-30" data-aos="fade-up" data-aos-delay="400">
                        <div class="funfact-img">
                            <img src="{{asset('client/assets/images/icon-img/award.png')}}" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-6">
                    <div class="single-funfact text-center mb-30" data-aos="fade-up" data-aos-delay="600">
                        <div class="funfact-img">
                            <img src="{{asset('client/assets/images/icon-img/item.png')}}" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-6">
                    <div class="single-funfact text-center mb-30 mrgn-none" data-aos="fade-up" data-aos-delay="800">
                        <div class="funfact-img">
                            <img src="{{asset('client/assets/images/icon-img/cup.png')}}" alt="">
                        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4 col-12">
                    <div class="single-team-wrap text-center mb-30" data-aos="fade-up" data-aos-delay="200">
                        <img src="{{asset('client/assets/images/team/team-1.png')}}" alt="">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-12">
                    <div class="single-team-wrap text-center mb-30" data-aos="fade-up" data-aos-delay="400">
                        <img src="{{asset('client/assets/images/team/team-2.png')}}" alt="">
                        <div class="team-info-position">
                            <div class="team-info">
                                <h3>Kari Rasmus</h3>
                                <span>Sales Man</span>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-12">
                    <div class="single-team-wrap text-center mb-30" data-aos="fade-up" data-aos-delay="600">
                        <img src="{{asset('client/assets/images/team/team-3.png')}}" alt="">
                        <div class="team-info-position">
                            <div class="team-info">
                                <h3>Kari Rasmus</h3>
                                <span>Sales Man</span>
